...
public class KDTree {
	 ...
	 *             if key.length mismatches K
	 */
	public Object nearest(double[] key, double alpha) {

		Object[] nbrs = nearest(key, 1, alpha);
		return nbrs[0];
	}
	 ...
	 */
	public Object[] nearest(double[] key, int n, double alpha) {
		...
		KDNode.nnbr(m_root, keyp, hr, max_dist_sqd, 0, m_K, nnl, alpha);
